    ...
    >
      ...
      <template #tableHeader="scope">
        <el-button type="primary"
          v-auth="'three.device.type.create'"
          :icon="CirclePlus"
          @click="openAddEdit('新增设备类型管理')"
        >
          新增
        </el-button>
        <el-button
        ...
        <el-button
          v-auth="'three.device.type.import'"
          type="primary"
          :icon="Upload"
          plain
          @click="importData"
        ...
        <el-button
          v-auth="'three.device.type.export'"
          type="primary"
          :icon="Download"
          plain
          @click="downloadFile"
...
const columns: ColumnProps<IThreeDeviceType.Row>[] = [
  ...
  { prop: 'effectiveHighVoltage', label: '是否为高电平有效' },
  { prop: 'name', label: '类型名称' },
  { prop: 'operation', label: '操作', width: 250, fixed: 'right' }
]
// 搜索条件项
const searchColumns: SearchProps[] = [
  { prop: 'effectiveHighVoltage', label: '是否为高电平有效', el: 'input' },
