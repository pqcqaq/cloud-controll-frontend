  ...
  >
    ...
    >
      ...
      <el-form-item label="DI扫描间隔" prop="diScanGap">
        <el-input-number
          v-model="paramsProps.row.diScanGap" :precision="0" :min="1" :max="999999" />
      </el-form-item>
      <el-form-item label="状态回传间隔" prop="stateCallbackGap">
        <el-input-number
          v-model="paramsProps.row.stateCallbackGap" :precision="0" :min="1" :max="999999" />
      </el-form-item>
      <el-form-item label="初始状态是否锁机" prop="lockOnStartup">
        <el-input-number
          v-model="paramsProps.row.lockOnStartup" :precision="0" :min="1" :max="999999" />
      </el-form-item>
