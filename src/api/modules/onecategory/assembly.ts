 ...
 * 获取产品类别标签
 */
export const listCategoryLabelApi = (params: { needSn?: boolean; needMidBox?: boolean; needPallet?: boolean }) => {
  return http.get<IOneCategory.CategoryLabelVo[]>(ADMIN_MODULE + `/one-category/list-category-label`, params);
};
